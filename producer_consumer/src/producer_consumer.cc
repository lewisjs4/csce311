...
//
//
#include <producer_consumer/include/thread.h>
#include <producer_consumer/include/thread_sem_manager.h>
...
const size_t kMaxConsumptionTime = 24;  // max time to consume a unit of work
const size_t kNoConsumers = 25;  // number of consumers

const size_t kBufferSize = 4;  // size of circular buffer
