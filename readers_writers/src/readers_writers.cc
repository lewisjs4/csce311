...
//     size_t indices.
class SemaphoreManager : public csce311::ThreadSemaphoreManager {
 public:
...
size_t SemaphoreManager::Create(size_t count, SemaphoreId id) {
  return csce311::ThreadSemaphoreManager::Create(count, static_cast<int>(id));
}


void SemaphoreManager::Down(SemaphoreId id) {
  csce311::ThreadSemaphoreManager::Down(static_cast<int>(id));
}


void SemaphoreManager::Up(SemaphoreId id) {
  csce311::ThreadSemaphoreManager::Up(static_cast<int>(id));
}
